...
import { INVENTORYWAREHOUSES_DECLARATIONS } from '../pages/inventory-warehouses';
import { INVENTORYWAREHOUSE_DECLARATIONS } from '../pages/inventory-warehouse';
...
@NgModule({
  ...
  entryComponents: [
    ...
    PERMISSIONMODULEDIALOG_ENTRYCOMPONENTS,
    TENANTMODULEDIALOG_ENTRYCOMPONENTS,
    INVENTORYWAREHOUSES_DECLARATIONS,
    INVENTORYWAREHOUSE_DECLARATIONS,
